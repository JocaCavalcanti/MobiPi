...
import Icard from "../../assets/images19.png"
import Icard2 from "../../assets/images20.png"
import Icard3 from "../../assets/matricula9.png"
...
export default function App() {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <View style={styles.card}>
        <Image source={Icard2} style={styles.cardImage}/>
        <View style={styles.cardContent}>
          <View style={styles.textContainer}>
            <Text style={styles.cardText}>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus scelerisque consequat lorem, vel consequat nisi ultrices ac. Donec mattis justo a nisi sagittis, in bibendum nunc dictum.
      ...
      <View style={styles.separator} />
      <View style={styles.card}>
        <Image source={Icard3} style={styles.cardImage}/>
        <View style={styles.cardContent}>
          <View style={styles.textContainer}>
            <Text style={styles.cardText}>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus scelerisque consequat lorem, vel consequat nisi ultrices ac. Donec mattis justo a nisi sagittis, in bibendum nunc dictum.
